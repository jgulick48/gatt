...
## Usage
Please see [godoc.org](http://godoc.org/github.com/jgulick48/gatt) for documentation.
...
Please check [#32](https://github.com/jgulick48/gatt/issues/32) for the status of this issue.
